...
This guide covers best practices for integrating telemetry-kit into different types of Rust projects.
...
// In Cargo.toml
[dependencies]
telemetry-kit = { version = "0.2", optional = true }
...
- [Privacy Compliance Guide](/docs/privacy-compliance) - GDPR/CCPA compliance
- [Self-Hosting Guide](/docs/self-hosting) - Deploy your own server
