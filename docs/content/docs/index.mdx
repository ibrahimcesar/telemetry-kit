...
- **[Configure Auto-Sync](/auto-sync)** - Learn how to enable automatic background synchronization
- **[CLI Tool](/cli)** - Manage telemetry from the command line
- **[API Reference](/api)** - Explore the complete API documentation
- **[Self-Hosting](/self-hosting)** - Deploy your own telemetry server
