...
See [Auto-Sync Guide](/auto-sync) for details.
...
1. **Managed Service (Recommended)** - Use our hosted service at [telemetry-kit.dev](https://telemetry-kit.dev). Get started instantly with a dashboard, analytics, and zero infrastructure to maintain.

2. **Self-Hosted** - Deploy your own telemetry server using our [production-ready server implementation](/self-hosting). Full control over your data, but requires infrastructure management.
